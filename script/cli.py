...
def account(
    ...
    try:
        ...
        output = Table(
            ...
            box=rich.box.ROUNDED, # Bordas arredondadas, super moderno!
            header_style="bold bright_blue", # Cabeçalho em azul brilhante e negrito
            row_styles=["none"], # Efeito "zebra" (uma linha normal, outra mais escura)
